...
public class AbilityData {
    ...
    public AbilityData(EntityEvolution plugin) {
        this.plugin = plugin;
        saveDefaultConfig();
    }
    ...
    public void reloadConfig() {
        if (this.configFile == null)
            this.configFile = new File(plugin.getDataFolder(), "abilities.yml");

        this.dataConfig = YamlConfiguration.loadConfiguration(this.configFile);

        InputStream defaultStream = plugin.getResource("abilities.yml");
